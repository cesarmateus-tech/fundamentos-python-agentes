...
def login(user: str ,passwrd: str) -> dict[str]:
    if usuario == "admin" and passwrd == "admin123":
        return {"rol": user, "access": True, "descripcion": "[Sistema] Acceso concedido. Privilegios de Administrador activados."}
        
    if usuario == "invitado" and passwrd == "1234":
        return {"rol": user, "access": True, "descripcion": "[Sistema] Acceso concedido. Modo Invitado."}
...
if tiene_acceso:    
    ...
    while pseudo_activo:
        ...
        if cmd == "salir":
            ...
            #Para revisión autónoma: List comprehesion para resolver esta sección
            #Antes
            """tot_letras = len(pal)
            tot_vocales = 0
            tot_cons = 0
            ...
            if " " in cmd:
                ...
                """if sing == "all":
                    ...
                    print("[PseudoAgente] Historial borrado.")
